...
namespace AssuranceWebAspNet.Pages.Assurance
{
    public partial class Experts : System.Web.UI.Page
    {
        ...
        {
            Session["target"] = "/Pages/Assurance/Experts";
            loadUsers();
        }

        public void loadUsers()
        {
            List<UserAccount> liste = u.Users.Where(u => u.Role == "Expert").ToList();
            TableRow th, tr;
        ...
        public void button_AjoutExpert_Click(object sender, EventArgs e)
        {
